...
<div class="signup-container">
  ...
  <form action="/signup" method="post" onsubmit="return validateSignupForm();">
    <div class="signup-2col">
      ...
      <div class="signup-left">
        ...
        <div class="form-group">
          <label for="userId">
            <span class="required-star">*</span> 아이디
            <span id="id-status-icon" class="status-icon"></span>
          </label>
          <div class="input-with-btn">
            <input type="text" name="userId" id="userId" required autocomplete="off">
        ...
        <div class="form-group">
          <label for="pwd">
            <span class="required-star">*</span> 비밀번호
            <span id="pwd-status-icon" class="status-icon"></span>
          </label>
        ...
        <div class="form-group">
          <label for="pwdCheck">
            <span class="required-star">*</span> 비밀번호 확인
            <span id="pwdCheck-status-icon" class="status-icon"></span>
          </label>
          <input type="password" id="pwdCheck" required autocomplete="off">
          <ul class="check-list" id="pw-match-check-list" style="display:none;">
        ...
        <div class="form-group">
          <label for="email">
            <span class="required-star">*</span> 이메일
            <span id="email-status-icon" class="status-icon"></span>
          </label>
          <div class="input-with-btn">
        ...
        <div class="form-group" id="auth-code-section" style="display: none;">
          <label for="emailCode"><span class="required-star">*</span> 인증 코드 입력</label>
          <div class="input-with-btn">
      ...
      <div class="signup-right">
        ...
        <div class="form-group">
          <label for="userName">
            <span class="required-star">*</span> 이름
            <span id="userName-status-icon" class="status-icon"></span>
          </label>
        ...
        <div class="form-group">
          <label for="userNickname">
            <span class="required-star">*</span> 닉네임
            <span id="userNickname-status-icon" class="status-icon"></span>
          </label>
          <input type="text" name="userNickname" id="userNickname" required autocomplete="off" maxlength="10">
          <div class="nickname-warning" style="display: none;">
            <span class="text-red">*</span> 부적절한 단어나 욕설이 포함될 경우, 운영자에 의해 이용이 제한될 수 있습니다.
          </div>
        </div>
        ...
        <div class="form-group tel-group">
          <label>전화번호</label>
          <div class="tel-input">
            <input type="text" id="userTel1" maxlength="3"> -
            <input type="text" id="userTel2" maxlength="4"> -
            <input type="text" id="userTel3" maxlength="4">
          </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="petName" id="petName" maxlength="10">
        </div>
    ...
    <div class="form-actions">
      <button type="button" class="cancel-btn" onclick="location.href='/main'">가입취소</button>
